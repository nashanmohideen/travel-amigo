    ...
    <div className="min-h-screen bg-stone-50 flex items-center justify-center px-4">
      <div className="text-center max-w-sm">
        ...
        <p className="text-sm text-stone-500 mb-6">
          This shared itinerary is not available in this prototype. It may have
          been cleared or shared from a different browser.
        </p>
        <Link
          href="/plan"
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="bg-teal-50 border-b border-teal-200 px-4 py-3 text-center">
        ...
        <p className="text-xs text-teal-600 mt-0.5">
          This shared itinerary is only available in the same browser it was shared from, during the prototype.
        </p>
      </div>
